 ...
 */
export type State = unknown; // object | null;
...
export interface History<S extends State = State> {
     ...
     */
    push(to: To, state?: S, updateMode?: UpdateMode, noListener?: boolean): void;
     ...
     */
    replace(to: To, state?: S, updateMode?: UpdateMode, noListener?: boolean): void;
...
const readOnly: <T extends unknown>(obj: T) => T = (typeof Object.freeze === "function")
...
export function createBrowserHistory(
    ...
    function applyTx(nextAction: Action, updateMode: UpdateMode) {
        action = nextAction;
        [index, location] = getIndexAndLocation();
        listeners.call({ action, location, updateMode });
    }

    function push(to: To, state?: State, updateMode?: UpdateMode, noListener?: boolean) {
    ...
    function replace(to: To, state?: State, updateMode?: UpdateMode, noListener?: boolean) {
...
export function createMemoryHistory(
    ...
    function applyTx(nextAction: Action, nextLocation: Location, updateMode: UpdateMode) {
        action = nextAction;
        location = nextLocation;
        listeners.call({ action, location, updateMode });
    }
